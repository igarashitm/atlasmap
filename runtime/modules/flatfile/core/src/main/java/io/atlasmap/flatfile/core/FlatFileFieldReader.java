 ...
 */
package io.atlasmap.flatfile.core;
...
public class FlatFileFieldReader implements AtlasFieldReader {

    private static final Logger LOG = LoggerFactory.getLogger(FlatFileFieldReader.class);

    private AtlasConversionService conversionService;
    private JsonNode rootNode;

    @SuppressWarnings("unused")
    private FlatFileFieldReader() {
    }

    public FlatFileFieldReader(AtlasConversionService conversionService) {
