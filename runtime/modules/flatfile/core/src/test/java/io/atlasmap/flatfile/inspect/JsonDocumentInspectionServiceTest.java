...
public class JsonDocumentInspectionServiceTest {
    ...
    private final FlatFileInspectionService inspectionService = new FlatFileInspectionService();

    @Test(expected = IllegalArgumentException.class)
    public void inspectJsonDocumentEmpty() throws Exception {
        final String instance = "";
        inspectionService.inspectFlatFileDocument(instance);
    }
    ...
    @Test(expected = FlatFileInspectionException.class)
    ...
    public void inspectJsonDocumentEmptyDocument() throws Exception {
        final String instance = "{}";
        JsonDocument document = inspectionService.inspectFlatFileDocument(instance);
