...
public class AtlasFlatFileModelFactory {

    public static final String URI_FORMAT = "atlas:flatfile";

    public static FlatFileDocument createFlatFileDocument() {
        FlatFileDocument ffDocument = new FlatFileDocument();
        ffDocument.setFields(new Fields());
        return ffDocument;
    }

    public static FlatFileField createFlatFileField() {
        FlatFileField flatFileField = new FlatFileField();
        return flatFileField;
    }

    public static String toString(FlatFileField f) {
        return "FlatFileField [name=" + f.getName() + ", columnIndex=" + f.getColumnIndex() + ", primitive=" + f.isPrimitive()
    ...
    public static Field cloneField(Field field) {
        FlatFileField clone = new FlatFileField();
        FlatFileField that = (FlatFileField) field;
        ...
        clone.setColumnIndex(that.getColumnIndex());
